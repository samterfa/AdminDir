	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	customers.patch <- function(customerKey, kind = NULL, customerDomain = NULL, alternateEmail = NULL, phoneNumber = NULL, etag = NULL, id = NULL, customerCreationTime = NULL, postalAddress = NULL, language = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.customers.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	customers.update <- function(customerKey, kind = NULL, customerDomain = NULL, alternateEmail = NULL, phoneNumber = NULL, etag = NULL, id = NULL, customerCreationTime = NULL, postalAddress = NULL, language = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.customers.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
