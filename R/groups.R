	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.insert <- function(adminCreated = NULL, id = NULL, name = NULL, description = NULL, etag = NULL, nonEditableAliases = NULL, directMembersCount = NULL, kind = NULL, aliases = NULL, email = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.list <- function(customer = NULL, query = NULL, sortOrder = NULL, pageToken = NULL, orderBy = NULL, userKey = NULL, domain = NULL, maxResults = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.patch <- function(groupKey, adminCreated = NULL, id = NULL, name = NULL, description = NULL, etag = NULL, nonEditableAliases = NULL, directMembersCount = NULL, kind = NULL, aliases = NULL, email = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	groups.update <- function(groupKey, adminCreated = NULL, id = NULL, name = NULL, description = NULL, etag = NULL, nonEditableAliases = NULL, directMembersCount = NULL, kind = NULL, aliases = NULL, email = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.groups.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
