	...
	#' @export
	channels.stop <- function(address = NULL, token = NULL, resourceId = NULL, expiration = NULL, id = NULL, kind = NULL, params = NULL, type = NULL, payload = NULL, resourceUri = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['admin.channels.stop']]$scopes), return_response = F){
