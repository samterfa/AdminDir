	...
	#' @export
	members.delete <- function(groupKey, memberKey, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.delete']]$scopes), return_response = F){
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.insert <- function(groupKey, type = NULL, kind = NULL, role = NULL, etag = NULL, email = NULL, status = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.list <- function(groupKey, includeDerivedMembership = NULL, roles = NULL, maxResults = NULL, pageToken = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.patch <- function(memberKey, groupKey, type = NULL, kind = NULL, role = NULL, etag = NULL, email = NULL, status = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	members.update <- function(groupKey, memberKey, type = NULL, kind = NULL, role = NULL, etag = NULL, email = NULL, status = NULL, id = NULL, delivery_settings = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.members.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
