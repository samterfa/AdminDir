	...
	#' @export
	roles.delete <- function(customer, roleId, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.delete']]$scopes), return_response = F){
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.get <- function(roleId, customer, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.get']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.insert <- function(customer, roleDescription = NULL, etag = NULL, rolePrivileges = NULL, isSuperAdminRole = NULL, kind = NULL, roleId = NULL, roleName = NULL, isSystemRole = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.insert']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.patch <- function(roleId, customer, roleDescription = NULL, etag = NULL, rolePrivileges = NULL, isSuperAdminRole = NULL, kind = NULL, roleName = NULL, isSystemRole = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	roles.update <- function(customer, roleId, roleDescription = NULL, etag = NULL, rolePrivileges = NULL, isSuperAdminRole = NULL, kind = NULL, roleName = NULL, isSystemRole = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.roles.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
