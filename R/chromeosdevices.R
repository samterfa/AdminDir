	...
	#' @export
	chromeosdevices.action <- function(customerId, resourceId, action = NULL, deprovisionReason = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.action']]$scopes), return_response = F){
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.list <- function(customerId, maxResults = NULL, pageToken = NULL, sortOrder = NULL, orgUnitPath = NULL, projection = NULL, query = NULL, orderBy = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.list']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.patch <- function(customerId, deviceId, projection = NULL, deviceFiles = NULL, ethernetMacAddress = NULL, orgUnitPath = NULL, screenshotFiles = NULL, recentUsers = NULL, lastEnrollmentTime = NULL, firmwareVersion = NULL, annotatedUser = NULL, lastSync = NULL, manufactureDate = NULL, macAddress = NULL, ethernetMacAddress0 = NULL, serialNumber = NULL, diskVolumeReports = NULL, status = NULL, systemRamFreeReports = NULL, etag = NULL, orderNumber = NULL, kind = NULL, lastKnownNetwork = NULL, model = NULL, bootMode = NULL, activeTimeRanges = NULL, annotatedLocation = NULL, tpmVersionInfo = NULL, annotatedAssetId = NULL, osVersion = NULL, supportEndDate = NULL, platformVersion = NULL, autoUpdateExpiration = NULL, dockMacAddress = NULL, systemRamTotal = NULL, notes = NULL, cpuStatusReports = NULL, willAutoRenew = NULL, meid = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.patch']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
	...
	#' @param return_response Whether to return the response or the response content. Defaults to FALSE (return response content).
	#' @export
	chromeosdevices.update <- function(customerId, deviceId, projection = NULL, deviceFiles = NULL, ethernetMacAddress = NULL, orgUnitPath = NULL, screenshotFiles = NULL, recentUsers = NULL, lastEnrollmentTime = NULL, firmwareVersion = NULL, annotatedUser = NULL, lastSync = NULL, manufactureDate = NULL, macAddress = NULL, ethernetMacAddress0 = NULL, serialNumber = NULL, diskVolumeReports = NULL, status = NULL, systemRamFreeReports = NULL, etag = NULL, orderNumber = NULL, kind = NULL, lastKnownNetwork = NULL, model = NULL, bootMode = NULL, activeTimeRanges = NULL, annotatedLocation = NULL, tpmVersionInfo = NULL, annotatedAssetId = NULL, osVersion = NULL, supportEndDate = NULL, platformVersion = NULL, autoUpdateExpiration = NULL, dockMacAddress = NULL, systemRamTotal = NULL, notes = NULL, cpuStatusReports = NULL, willAutoRenew = NULL, meid = NULL, gargle_token = gargle::token_fetch(scopes = .endpoints[['directory.chromeosdevices.update']]$scopes), return_response = F){
		params <- as.list(environment())[!names(as.list(environment())) %in% c('return_response', 'gargle_token')]
